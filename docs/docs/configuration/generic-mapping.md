...
DomainMap supports generic user defined mapping methods.
DomainMap implements this mapping method
...
:::warning
DomainMap generic mappings and runtime target type parameter mappings

---
sidebar_position: 22
description: A list of all analyzer diagnostics used by DomainMap and how to configure them.
---
...
DomainMap emits several diagnostics:

<AnalyzerRules></AnalyzerRules>

:::info
DomainMap only emits updated source code on build.
...
## Configure diagnostics / editorconfig {#editorconfig}

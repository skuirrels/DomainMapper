...
DomainMap supports interfaces and base types as mapping sources and targets, for both new instance and [existing target](./existing-target.mdx) mappings.
To do this, DomainMap needs to know which derived types exist.

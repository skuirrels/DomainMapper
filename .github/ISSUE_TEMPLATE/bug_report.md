...
- [ ] I have read the local DomainMapper documentation, including the FAQ
- [ ] I can reproduce the bug using the latest prerelease version
- [ ] I have searched existing DomainMapper discussions and issues to avoid duplicates
...
**Repro**
A link to a repro Gist or GitHub repository or a link to a DomainMapper fork with a failing test.

**Declaration code**
```csharp
// Relevant code of the DomainMapper definition and all relevant classes
// or link to a GH Repro
```

**Actual relevant generated code**
```csharp
// Actual relevant code generated by DomainMapper
...
- DomainMapper Version: [e.g. 1.0.1]

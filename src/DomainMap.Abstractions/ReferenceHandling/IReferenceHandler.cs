...
{
    /// <summary>
    /// Before an object is created by DomainMap this method is called.
    /// It can attempt to resolve existing target object instances based on the source object instance.
    /// If <c>false</c> is returned, DomainMap creates a new instance of the target class.
    /// If <c>true</c> is returned, target has to be non-null.
    /// DomainMap then uses the target instance.
    /// </summary>
    ...
    /// Called by DomainMap just after a new target object instance is created.
    /// </summary>
    /// <param name="source">The source object instance.</param>

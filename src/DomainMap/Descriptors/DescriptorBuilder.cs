...
using DomainMap.Descriptors.ExternalMappings;
using DomainMap.Descriptors.FormatProviders;
using DomainMap.Descriptors.MappingBodyBuilders;
...
public class DescriptorBuilder
{
    ...
    private readonly ImmutableArray<UseStaticDomainMapperConfiguration> _assemblyScopedStaticMappers;

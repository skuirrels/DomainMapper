...
RMG014  | Mapper   | Warning  | Cannot map to the configured constructor to be used by DomainMap
...
RMG046  | Mapper   | Error    | The used C# language version is not supported by DomainMap, DomainMap requires at least C# 9.0

...
namespace DomainMap.Diagnostics;
...
public static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor IgnoredTargetMemberNotFound = new(
        "RMG004",
    ...
    public static readonly DiagnosticDescriptor ConfiguredMappingTargetMemberNotFound = new(
        "RMG005",
    ...
    public static readonly DiagnosticDescriptor ConfiguredMappingSourceMemberNotFound = new(
        "RMG006",
    ...
    public static readonly DiagnosticDescriptor CouldNotMapMember = new(
        "RMG007",
    ...
    public static readonly DiagnosticDescriptor CannotMapToReadOnlyMember = new(
        "RMG009",
    ...
    public static readonly DiagnosticDescriptor CannotMapFromWriteOnlyMember = new(
        "RMG010",
    ...
    public static readonly DiagnosticDescriptor CannotMapToWriteOnlyMemberPath = new(
        "RMG011",
    ...
    public static readonly DiagnosticDescriptor SourceMemberNotFound = new(
        "RMG012",
    ...
    public static readonly DiagnosticDescriptor CannotMapToConfiguredConstructor = new(
        "RMG014",
        "Cannot map to the configured constructor to be used by DomainMap",
    ...
    public static readonly DiagnosticDescriptor CannotMapToInitOnlyMemberPath = new(
        "RMG015",
    ...
    public static readonly DiagnosticDescriptor InitOnlyMemberDoesNotSupportPaths = new(
        "RMG016",
    ...
    public static readonly DiagnosticDescriptor SourceMemberNotMapped = new(
        "RMG020",
    ...
    public static readonly DiagnosticDescriptor IgnoredSourceMemberNotFound = new(
        "RMG021",
    ...
    public static readonly DiagnosticDescriptor RequiredMemberNotMapped = new(
        "RMG023",
    ...
    public static readonly DiagnosticDescriptor ReferenceHandlerParameterWrongType = new(
        "RMG024",
    ...
    public static readonly DiagnosticDescriptor ReferenceHandlingNotEnabled = new(
        "RMG025",
        "To use reference handling it needs to be enabled on the mapper attribute",
        $"{{0}}.{{1}} uses reference handling, but it is not enabled on the mapper attribute, to enable reference handling set {nameof(DomainMapperAttribute.UseReferenceHandling)} to true",
        DiagnosticCategories.Mapper,
        DiagnosticSeverity.Error,
        true
    );

    public static readonly DiagnosticDescriptor QueryableProjectionMappingsDoNotSupportReferenceHandling = new(
        "RMG029",
    ...
    public static readonly DiagnosticDescriptor ReferenceLoopInInitOnlyMapping = new(
        "RMG030",
    ...
    public static readonly DiagnosticDescriptor ReferenceLoopInCtorMapping = new(
        "RMG031",
    ...
    public static readonly DiagnosticDescriptor MappedObjectToObjectWithoutDeepClone = new(
        "RMG033",
    ...
    public static readonly DiagnosticDescriptor DerivedSourceTypeDuplicated = new(
        "RMG034",
    ...
    public static readonly DiagnosticDescriptor DerivedSourceTypeIsNotAssignableToParameterType = new(
        "RMG035",
    ...
    public static readonly DiagnosticDescriptor DerivedTargetTypeIsNotAssignableToReturnType = new(
        "RMG036",
    ...
    public static readonly DiagnosticDescriptor TargetEnumValueNotMapped = new(
        "RMG037",
    ...
    public static readonly DiagnosticDescriptor SourceEnumValueNotMapped = new(
        "RMG038",
    ...
    public static readonly DiagnosticDescriptor EnumSourceValueDuplicated = new(
        "RMG039",
    ...
    public static readonly DiagnosticDescriptor TargetEnumValueDoesNotMatchTargetEnumType = new(
        "RMG040",
    ...
    public static readonly DiagnosticDescriptor SourceEnumValueDoesNotMatchSourceEnumType = new(
        "RMG041",
    ...
    public static readonly DiagnosticDescriptor EnumFallbackValueTypeDoesNotMatchTargetEnumType = new(
        "RMG042",
    ...
    public static readonly DiagnosticDescriptor EnumFallbackValueRequiresByValueCheckDefinedStrategy = new(
        "RMG043",
    ...
    public static readonly DiagnosticDescriptor IgnoredEnumSourceMemberNotFound = new(
        "RMG044",
    ...
    public static readonly DiagnosticDescriptor IgnoredEnumTargetMemberNotFound = new(
        "RMG045",
    ...
    public static readonly DiagnosticDescriptor LanguageVersionNotSupported = new(
        "RMG046",
        "The used C# language version is not supported by DomainMap, DomainMap requires at least C# 9.0",
        "DomainMap does not support the C# language version {0} but requires at C# least version {1}",
        DiagnosticCategories.Mapper,
        DiagnosticSeverity.Error,
        true
    );

    public static readonly DiagnosticDescriptor CannotMapToTemporarySourceMember = new(
        "RMG047",
    ...
    public static readonly DiagnosticDescriptor ExternalMapperMemberCannotBeNullable = new(
        "RMG048",
    ...
    public static readonly DiagnosticDescriptor IgnoredSourceMemberExplicitlyMapped = new(
        "RMG049",
    ...
    public static readonly DiagnosticDescriptor IgnoredTargetMemberExplicitlyMapped = new(
        "RMG050",
    ...
    public static readonly DiagnosticDescriptor NestedIgnoredSourceMember = new(
        "RMG051",
    ...
    public static readonly DiagnosticDescriptor NestedIgnoredTargetMember = new(
        "RMG052",
    ...
    public static readonly DiagnosticDescriptor UnsafeAccessorNotAvailable = new(
        "RMG053",
    ...
    public static readonly DiagnosticDescriptor MixingStaticPartialWithInstanceMethod = new(
        "RMG054",
    ...
    public static readonly DiagnosticDescriptor SourceDoesNotImplementToStringWithFormatParameters = new(
        "RMG055",
    ...
    public static readonly DiagnosticDescriptor InvalidFormatProviderSignature = new(
        "RMG056",
    ...
    public static readonly DiagnosticDescriptor FormatProviderNotFound = new(
        "RMG057",
    ...
    public static readonly DiagnosticDescriptor MultipleDefaultFormatProviders = new(
        "RMG058",
    ...
    public static readonly DiagnosticDescriptor MultipleDefaultUserMappings = new(
        "RMG059",
    ...
    public static readonly DiagnosticDescriptor MultipleUserMappingsWithoutDefault = new(
        "RMG060",
    ...
    public static readonly DiagnosticDescriptor ReferencedMappingNotFound = new(
        "RMG061",
    ...
    public static readonly DiagnosticDescriptor ReferencedMappingAmbiguous = new(
        "RMG062",
    ...
    public static readonly DiagnosticDescriptor EnumConfigurationOnNonEnumMapping = new(
        "RMG063",
    ...
    public static readonly DiagnosticDescriptor MemberConfigurationOnNonMemberMapping = new(
        "RMG064",
    ...
    public static readonly DiagnosticDescriptor MemberConfigurationOnQueryableProjectionMapping = new(
        "RMG065",
    ...
    public static readonly DiagnosticDescriptor NoMemberMappings = new(
        "RMG066",
    ...
    public static readonly DiagnosticDescriptor InvalidMapPropertyAttributeUsage = new(
        "RMG067",
    ...
    public static readonly DiagnosticDescriptor QueryableProjectionMappingCannotInline = new(
        "RMG068",
    ...
    public static readonly DiagnosticDescriptor RuntimeTargetTypeMappingNoContentMappings = new(
        "RMG069",
    ...
    public static readonly DiagnosticDescriptor ConfiguredMappingNestedMemberNotFound = new(
        "RMG070",
    ...
    public static readonly DiagnosticDescriptor NestedMemberNotUsed = new(
        "RMG071",
    ...
    public static readonly DiagnosticDescriptor ReferencedMappingSourceTypeMismatch = new(
        "RMG072",
    ...
    public static readonly DiagnosticDescriptor ReferencedMappingTargetTypeMismatch = new(
        "RMG073",
    ...
    public static readonly DiagnosticDescriptor MultipleConfigurationsForTargetMember = new(
        "RMG074",
    ...
    public static readonly DiagnosticDescriptor InvalidMapValueAttributeUsage = new(
        "RMG075",
    ...
    public static readonly DiagnosticDescriptor CannotMapValueNullToNonNullable = new(
        "RMG076",
    ...
    public static readonly DiagnosticDescriptor MapValueMethodTypeMismatch = new(
        "RMG078",
    ...
    public static readonly DiagnosticDescriptor MapValueReferencedMethodNotFound = new(
        "RMG079",
    ...
    public static readonly DiagnosticDescriptor MapValueUnsupportedType = new(
        "RMG080",
    ...
    public static readonly DiagnosticDescriptor MappingMethodWithAdditionalParametersCannotBeDefaultMapping = new(
        "RMG081",
    ...
    public static readonly DiagnosticDescriptor AdditionalParameterNotMapped = new(
        "RMG082",
    ...
    public static readonly DiagnosticDescriptor CannotMapToReadOnlyType = new(
        "RMG083",
    ...
    public static readonly DiagnosticDescriptor EnumStringSourceValueDuplicated = new(
        "RMG084",
    ...
    public static readonly DiagnosticDescriptor InvalidEnumMappingFallbackValue = new(
        "RMG085",
    ...
    public static readonly DiagnosticDescriptor EnumExplicitMappingSourceNotString = new(
        "RMG086",
    ...
    public static readonly DiagnosticDescriptor EnumExplicitMappingTargetNotString = new(
        "RMG087",
    ...
    public static readonly DiagnosticDescriptor EnumNamingAttributeMissing = new(
        "RMG088",
    ...
    public static readonly DiagnosticDescriptor NullableSourceValueToNonNullableTargetValue = new(
        "RMG089",
    ...
    public static readonly DiagnosticDescriptor NullableSourceTypeToNonNullableTargetType = new(
        "RMG090",
    ...
    {
#if ENV_LOCAL
        return $"http://localhost:3000/docs/configuration/analyzer-diagnostics/{id}";
#else
        return null;
#endif
    }

...
/// <summary>
/// Contains all the properties of <see cref="DomainMapperAttribute"/> and <see cref="MapperDefaultsAttribute"/> but all of them are nullable.
/// This is needed to evaluate which properties are set in the <see cref="DomainMapperAttribute"/> and <see cref="MapperDefaultsAttribute"/>.
/// <remarks>
/// Newly added properties must also be added to <see cref="DomainMap.Configuration.MapperConfigurationMerger"/>.
/// </remarks>
/// </summary>
public record MapperConfiguration
{
    ...
    /// <inheritdoc cref="DomainMapperAttribute.IncludedConstructors"/>

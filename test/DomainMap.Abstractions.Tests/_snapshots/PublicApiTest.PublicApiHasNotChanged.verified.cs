...
namespace DomainMap.Abstractions
{
    ...
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    public class DomainMapperAttribute : System.Attribute
    {
        public DomainMapperAttribute() { }
        public bool AllowNullPropertyAssignment { get; set; }
        public bool AutoUserMappings { get; set; }
        public DomainMap.Abstractions.MappingConversionType EnabledConversions { get; set; }
        public bool EnumMappingIgnoreCase { get; set; }
        public DomainMap.Abstractions.EnumMappingStrategy EnumMappingStrategy { get; set; }
        public DomainMap.Abstractions.EnumNamingStrategy EnumNamingStrategy { get; set; }
        public DomainMap.Abstractions.IgnoreObsoleteMembersStrategy IgnoreObsoleteMembersStrategy { get; set; }
        public DomainMap.Abstractions.MemberVisibility IncludedConstructors { get; set; }
        public DomainMap.Abstractions.MemberVisibility IncludedMembers { get; set; }
        public bool PreferParameterlessConstructors { get; set; }
        public DomainMap.Abstractions.PropertyNameMappingStrategy PropertyNameMappingStrategy { get; set; }
        public DomainMap.Abstractions.RequiredMappingStrategy RequiredEnumMappingStrategy { get; set; }
        public DomainMap.Abstractions.RequiredMappingStrategy RequiredMappingStrategy { get; set; }
        public DomainMap.Abstractions.StackCloningStrategy StackCloningStrategy { get; set; }
    ...
    {
        public MapEnumAttribute(DomainMap.Abstractions.EnumMappingStrategy strategy) { }
        public object? FallbackValue { get; set; }
        public bool IgnoreCase { get; set; }
        public DomainMap.Abstractions.EnumNamingStrategy NamingStrategy { get; set; }
        public DomainMap.Abstractions.EnumMappingStrategy Strategy { get; }
    }
    [System.AttributeUsage(System.AttributeTargets.Method, AllowMultiple=true)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    ...
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    public sealed class MapperDefaultsAttribute : DomainMap.Abstractions.DomainMapperAttribute
    {
    ...
    {
        public MapperIgnoreObsoleteMembersAttribute(DomainMap.Abstractions.IgnoreObsoleteMembersStrategy ignoreObsoleteStrategy = -1) { }
        public DomainMap.Abstractions.IgnoreObsoleteMembersStrategy IgnoreObsoleteStrategy { get; }
    }
    [System.AttributeUsage(System.AttributeTargets.Method, AllowMultiple=true)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    ...
    {
        public MapperRequiredMappingAttribute(DomainMap.Abstractions.RequiredMappingStrategy requiredMappingStrategy) { }
        public DomainMap.Abstractions.RequiredMappingStrategy RequiredMappingStrategy { get; }
    }
    [System.Flags]
    ...
    [System.AttributeUsage(System.AttributeTargets.Property | System.AttributeTargets.Field)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    public sealed class UseDomainMapperAttribute : System.Attribute
    {
        public UseDomainMapperAttribute() { }
    }
    [System.AttributeUsage(System.AttributeTargets.Assembly | System.AttributeTargets.Class, AllowMultiple=true)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    public sealed class UseStaticDomainMapperAttribute : System.Attribute
    {
        public UseStaticDomainMapperAttribute(System.Type mapperType) { }
    }
    [System.AttributeUsage(System.AttributeTargets.Assembly | System.AttributeTargets.Class, AllowMultiple=true)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
    public sealed class UseStaticDomainMapperAttribute<T> : System.Attribute
    {
        public UseStaticDomainMapperAttribute() { }
    }
    [System.AttributeUsage(System.AttributeTargets.Method)]
    [System.Diagnostics.Conditional("DOMAINMAP_ABSTRACTIONS_SCOPE_RUNTIME")]
...
namespace DomainMap.Abstractions.ReferenceHandling
{
    ...
    public sealed class PreserveReferenceHandler : DomainMap.Abstractions.ReferenceHandling.IReferenceHandler
    {

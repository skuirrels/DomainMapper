...
public static class TestHelper
{
    ...
    {
        var generator = new DomainMapGenerator();
    ...
    )
    {
        ...
        if (addDomainMapReferences)
        {
            compilation = compilation.AddReferences(
                MetadataReference.CreateFromFile(typeof(DomainMapGenerator).Assembly.Location),
                MetadataReference.CreateFromFile(typeof(DomainMapperAttribute).Assembly.Location)
            );
        }
